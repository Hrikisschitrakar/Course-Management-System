...
public class DeleteInstructorForm extends JPanel {
	...
	public DeleteInstructorForm() {
		...
		instructorIDLabel.setBounds(27, 78, 93, 37);
		formPanel.add(instructorIDLabel);
		
		instructorIDTextField = new JTextField();
		instructorIDTextField.setBounds(130, 79, 305, 34);
		...
		JLabel lblNewLabel = new JLabel("Remove Instructor ");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 15));
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setBounds(27, 27, 149, 24);
