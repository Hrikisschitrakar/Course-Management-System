...
public class ResultPublishSuccessful extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ResultPublishSuccessful() {
		...
		JLabel messageLabel = new JLabel("Result published successfully.");
		messageLabel.setForeground(Color.WHITE);
		messageLabel.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		messageLabel.setBounds(62, 60, 239, 28);
