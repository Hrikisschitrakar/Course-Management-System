...
public class MarksAlreadyAssigned extends JFrame {
	...
	public MarksAlreadyAssigned() {
		...
		JLabel messageLabel = new JLabel("Marks is already assigned for this student.");
		messageLabel.setForeground(Color.WHITE);
		messageLabel.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		messageLabel.setBounds(11, 61, 332, 28);
