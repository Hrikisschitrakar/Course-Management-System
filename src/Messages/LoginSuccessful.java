...
public class LoginSuccessful extends JFrame {
	...
	public LoginSuccessful() {
		...
		JLabel successfulLabel = new JLabel("Login Successful!!!");
		successfulLabel.setFont(new Font("Lucida Grande", Font.BOLD, 13));
		successfulLabel.setForeground(Color.WHITE);
		successfulLabel.setBackground(new Color(165, 205, 255));
		successfulLabel.setBounds(114, 6, 124, 16);
		...
		welcomeLabel.setBounds(19, 57, 319, 40);
