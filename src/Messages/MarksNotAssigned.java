...
public class MarksNotAssigned extends JFrame {
	...
	public MarksNotAssigned() {
		...
		JLabel messageLabel = new JLabel("No Results Published Yet");
		messageLabel.setForeground(Color.WHITE);
		messageLabel.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		messageLabel.setBounds(92, 46, 196, 28);
