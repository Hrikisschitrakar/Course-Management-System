...
public class MarksAssignedSuccessful extends JFrame {
	 ...
	 * Create the frame.
	 */
	public MarksAssignedSuccessful() {
		...
		JLabel messageLabel = new JLabel("Marks assigned successfully.");
		messageLabel.setForeground(Color.WHITE);
		messageLabel.setFont(new Font("Lucida Grande", Font.BOLD, 15));
		messageLabel.setBounds(65, 61, 232, 28);
